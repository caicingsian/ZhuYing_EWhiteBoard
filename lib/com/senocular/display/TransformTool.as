package com.senocular.display {
	...
	public class TransformTool extends Sprite {
		...
		public static const CONTROL_UNFOCUS:String = "controlUnfocus";
...
//				if( _target.stage ) onTargetAddToStage(null);
//				else _target.addEventListener( ListenAddToStage , onTargetAddToStage );
			}
		...
		private function onTargetAddToStage(e:Event):void
		{
			_target.removeEventListener(Event.ADDED_TO_STAGE , onTargetAddToStage );
			_target.stage.addEventListener( MouseEvent.MOUSE_DOWN , onStageMouseDown );
		}
		
		private function onStageMouseDown(e:MouseEvent):void
		{
			if( _target && 
				_target.hitTestPoint( mouseX , mouseY , true ) == false &&
				this.hitTestPoint( mouseX , mouseY , true ) == false )
			{
				dispatchEvent( new Event( CONTROL_UNFOCUS ) );
			}			
		}
